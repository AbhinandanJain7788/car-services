...
export default function ElectricalServicesTable() {
  return (
      ...
      <div className="w-full px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-6 text-[15px] leading-7 text-gray-300">
            Professional electrical diagnostics and repair services designed to ensure maximum safety,
            reliability, and smooth operation for your vehicle.
          </p>
        </div>

        {/* GRID (FULL WIDTH, CONTROLLED) */}
        <div className="max-w-7xl mx-auto grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {electricDiagnosticServices.map((service) => (
            <div
              key={service.title}
