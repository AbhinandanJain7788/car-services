...
import { transmissionServices } from "@/data/transmissionServices";

export default function TransmissionServicesTable() {
  return (
      ...
      <div className="w-full px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-6 text-[15px] leading-7 text-gray-300">
            Transmission services designed to ensure maximum safety,
            reliability, and smooth shifting performance for your vehicle.
          </p>
        </div>
