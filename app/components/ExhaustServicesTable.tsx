...
import { exhaustServices } from "@/data/exhaustServices";

export default function ExhaustServicesTable() {
  return (
      ...
      <div className="w-full px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-6 text-[15px] leading-7 text-gray-300">
           Professional exhaust service solutions designed to enhance performance, improve fuel efficiency, and ensure long-term reliability of your vehicle.
          </p>
        </div>

        {/* GRID (FULL WIDTH, CONTROLLED) */}
        <div className="max-w-7xl mx-auto grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {exhaustServices.map((service) => (
            <div
              key={service.name}
