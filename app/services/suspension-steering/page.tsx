...
import SuspensionServicesTable from "@/app/components/SuspensionServicesTable";
import { siteConfig } from "@/data/site";
export default function BrakeSystemPage() {
  return (
    <>
      {/* HERO */}
      <ServicesHero title="Suspension & Steering" breadcrumb="Suspension & Steering Services" />

      {/* PAGE CONTENT */}
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-14">
        
        {/* LEFT SIDEBAR */}
        <ServicesSidebar activeId="suspension-steering" />
 ...
 <div className="relative w-full h-[420px] rounded-md overflow-hidden">
              <Image
                src="/services/suspension.jpg"
                alt="Suspension & Steering Services"
                fill
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Suspension & Steering services are essential for maintaining vehicle stability, handling, and overall driving comfort. At Car Garage, we provide comprehensive suspension and steering services tailored to Japanese and Korean vehicles, ensuring optimal performance and safety.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
               If you have a problem with your suspension, you should contact a Car Suspension Repair mechanic who can diagnose and repair the problem. A shock absorber mechanic can determine which parts are required for your specific situation and whether they are available through a local dealership or specialty shop.
          ...
          <section className="mb-24">
            <h2 className="text-3xl font-semibold mb-12">
             Our Suspension & Steering Service Process
            </h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ["1", "Inspection & Diagnosis", "Complete check of suspension and steering components for wear, damage, and imbalance."],
                ["2", "Component Evaluation", "Shocks, struts, joints, and linkages assessed for performance and safety."],
                ["3", "Repair & Adjustment", "Faulty parts repaired or replaced and systems adjusted for proper control."],
                ["4", "Alignment & Calibration", "Wheel alignment and steering calibrated for smooth handling and stability."],
                ["5", "Final Road Test", "Test drive to ensure comfort, precise steering, and safe performance."],
              ].map(([step, title, text]) => (
                <div
                  key={step}
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    >
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 mt-4">
        Book Your Suspension & Steering Repair Service Today
      </h2>

      <p className="text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
        Drive safely with expert suspension and steering repair services performed by certified
