...
import TransmissionServicesTable from "@/app/components/TransmissionServicesTable";
import { siteConfig } from "@/data/site";
export default function BrakeSystemPage() {
  return (
    <>
      {/* HERO */}
      <ServicesHero title="Transmission Services" breadcrumb="Transmission Services" />

      {/* PAGE CONTENT */}
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-4 gap-14">
        
        {/* LEFT SIDEBAR */}
        <ServicesSidebar activeId="transmission-services" />
 ...
 <div className="relative w-full h-[420px] rounded-md overflow-hidden">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Transmission services are essential for maintaining vehicle stability, handling, and overall driving comfort. At Car Garage, we provide comprehensive transmission services tailored to Japanese and Korean vehicles, ensuring optimal performance and safety.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4">
               If you have a problem with your transmission, you should contact a Car Transmission Services mechanic who can diagnose and repair the problem. A transmission services mechanic can determine which parts are required for your specific situation and whether they are available through a local dealership or specialty shop.
          ...
          <section className="mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ["1", "System Inspection & Diagnosis", "Complete transmission check to detect leaks, wear, and performance issues."],
                ["2", "Fluid Condition Check", "Transmission fluid inspected for level, quality, and contamination."],
                ["3", "Component Assessment", "Gears, clutch system, sensors, and linkages evaluated for smooth operation."],
                ["4", "Repair & Fluid Service", "Worn components repaired or replaced, and fluid flushed or topped up as required."],
                ["5", "Final Road Test", "Test drive performed to ensure smooth shifting and reliable performance."],
              ].map(([step, title, text]) => (
                <div
                  key={step}
  ...
  <div className="max-w-6xl mx-auto px-6">
    ...
    >
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-5 mt-4">
        Book Your Transmission Services Today
      </h2>

      <p className="text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
        Drive safely with expert transmission services performed by certified
